...
import { Activity, Bot, FileSearch, Gauge, Key, Plus, Search, ShieldQuestion } from "lucide-react";
...
const ACTIONS: Action[] = [
  ...
  { label: "Approvals", href: "/approvals", icon: ShieldQuestion, group: "Navigate" },
